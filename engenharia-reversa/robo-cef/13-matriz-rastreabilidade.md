...
## Atualizacao 2026-07-07 - Assistente IA CEF

Foi criada a estrutura `external-agent/` para separar o objetivo final do projeto, o Assistente IA CEF, do crawler auxiliar. A mudanca nao altera regras de negocio do robo CEF; altera a organizacao arquitetural e cria ponto de evolucao para providers, tools, contexto e servicos do assistente.
